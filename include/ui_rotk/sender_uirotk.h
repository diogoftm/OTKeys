...
#define OUTPUT_LENGTH 128
	...
	void sender_output(OKDOT_SENDER *, unsigned long long int *, unsigned long long int *, unsigned int *, unsigned int *, unsigned int (*)[OUTPUT_LENGTH / 32]); // sample hash functions and set sender output
